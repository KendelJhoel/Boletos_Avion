...
namespace Boletos_Avion.Controllers
{
    public class CategoriasController:Controller
    {
        ...
        {
            DbController dbController = new DbController();
            // Filtra vuelos con duración <= 300 minutos (5 horas)
            List<Vuelo> vuelosEconomicos = dbController.GetVuelosByDuration(300) ?? new List<Vuelo>();
