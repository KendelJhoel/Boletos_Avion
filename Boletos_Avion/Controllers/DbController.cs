...
public class DbController
{
    ...
    public DbController()
    {
        ...
        //connectionString = "Data Source=DESKTOP-MP89LU5\\SQLEXPRESS;Initial Catalog=GestionBoletos;Integrated Security=True;TrustServerCertificate=True;";
    ...
    public UserModel GetUserById(int idUsuario)
    {
        ...
        {
            connection.Open();
            string query = "SELECT idUsuario, nombre, correo, telefono, direccion, documento_identidad, idRol FROM USUARIOS WHERE idUsuario = @Id";
    ...
    public bool UpdateUser(UserModel user)
    {
        string query = @"UPDATE USUARIOS 
                         SET nombre = @Nombre, correo = @Correo, telefono = @Telefono, direccion = @Direccion, 
                             documento_identidad = @Documento, idRol = @IdRol 
